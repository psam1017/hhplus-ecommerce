package hhplus.ecommerce.server.interfaces.web.item;
...
import hhplus.ecommerce.server.interfaces.web.item.model.response.ItemDetail;
import hhplus.ecommerce.server.interfaces.web.item.model.response.ItemPageResult;
import hhplus.ecommerce.server.interfaces.web.item.model.response.ItemSummary;
